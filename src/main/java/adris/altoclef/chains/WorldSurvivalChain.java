...
public class WorldSurvivalChain extends SingleTaskChain {
    ...
    public float getPriority(AltoClef mod) {
        ...
        if (mod.getModSettings().shouldExtinguishSelfWithWater()) {
            if (!(_mainTask instanceof EscapeFromLavaTask && isCurrentlyRunning(mod)) && mod.getPlayer().isOnFire() && !mod.getPlayer().hasStatusEffect(StatusEffects.FIRE_RESISTANCE) && !mod.getWorld().getRegistryKey().equals(net.minecraft.world.World.NETHER)) {
